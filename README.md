...
## What I did
3–5 bullet points. Not every step — just the meaningful ones.
- Downloaded and audited the raw data (X rows, Y columns)
- Found and handled Z issue (explain briefly how)
- Produced [finding] using [method]

## Key finding
One paragraph. Write this as if explaining to a policy
audience — not a technical one.
...
Honest reflection. This is what separates people who
learned something from people who just completed a task.
